...
// Warna canvas
gl.clearColor(0.0, 0.0, 0.0, 1.0); // Mengubah warna latar belakang menjadi hitam
...
gl.uniform4fv(colorLocation, [1.0, 0.0, 1.0, 1.0]); // Warna pink (R, G, B, A)
...
function updatePosition() {
  ...
  if (verticalPosition > 1.0) {
    // Reset ke bawah saat mencapai puncak
