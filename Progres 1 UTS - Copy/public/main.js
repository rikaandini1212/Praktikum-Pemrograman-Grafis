...
// Rintangan
var rintanganPosisiX = 1.0; // Mulai dari luar layar kanan
const rintanganLebar = 0.1;
const rintanganKecepatan = 0.01;
...
function GambarRintangan() {
  const rintanganVertices = [
    rintanganPosisiX, 0.0,
    rintanganPosisiX, 1.0,
    rintanganPosisiX + rintanganLebar, 0.0,
    rintanganPosisiX + rintanganLebar, 0.0,
    rintanganPosisiX + rintanganLebar, 1.0,
    rintanganPosisiX, 1.0,
  ];

  const positionBuffer = createAndBindBuffer(rintanganVertices);
...
function Animasi() {
  ...
  rintanganPosisiX -= rintanganKecepatan;
  if (rintanganPosisiX < -1.0) {
    rintanganPosisiX = 1.0; // Reset posisi rintangan ke luar layar kanan
  }
...
function Animasi() {
  ...
  gl.drawArrays(gl.TRIANGLES, 0, 6); // Menggunakan TRIANGLES untuk menggambar rintangan
